...
describe('jss-plugin-nested', () => {
  ...
  describe('order of nested conditionals', () => {
    ...
    it('should generate correct CSS', () => {
      expect(sheet.toString()).to.be('@media a {\n' + '  .a-id {\n' + '    color: red;\n' + '  }\n' + '}\n' + '@media b {\n' + '  .a-id {\n' + '    color: green;\n' + '  }\n' + '}');
    });
  });
  ...
  describe('warnings', () => {
    it('should warn when referenced rule is not found', () => {
      ...
      expect(spy.calledWithExactly('Warning: [JSS] Could not find the referenced rule b in .a-id {\n  & $b: [object Object];\n}.')).to.be(true);
    });
  });
  describe('local refs', () => {
    let sheet;
  ...
  describe.skip('nesting conditionals in combination with extend plugin', () => {
    ...
    it('should generate correct CSS', () => {
      expect(sheet.toString()).to.be('.button-id {\n' + '  color: green;\n' + '  background-color: aqua;\n' + '}\n' + '@media {\n' + '  .button-id {\n' + '    width: 200px;\n' + '  }\n' + '}\n' + '.redButton-id {\n' + '  color: red;\n' + '  background-color: aqua;\n' + '}\n' + '@media {\n' + '  .redButton-id {\n' + '    width: 200px;\n' + '  }\n' + '}');
    });
  });
  ...
  describe('deep nesting with multiple nestings in one selector', () => {
    ...
    it('should add rules', () => {
      ...
      expect(sheet.getRule('.button-id .a .c, .button-id .a:hover, .button-id .b .c, .button-id .b:hover')).to.not.be(undefined);
    });
    it('should generate correct CSS', () => {
