...
describe('jss-plugin-global', () => {
  ...
  describe('@global with nested rules inside', () => {
    ...
    it('should handle regular nested rules', () => {
      ...
      expect(sheet.toString()).to.be('button {\n  color: red;\n}\nbutton span {\n  color: green;\n}');
    });
    it('should handle nested rules inside of a rule with comma separated selector', () => {
      ...
      expect(sheet.toString()).to.be('button, a {\n' + '  color: red;\n' + '}\n' + 'button span, a span {\n' + '  color: green;\n' + '}');
    });
    ...
    it('should handle nested conditional rules', () => {
      ...
      expect(sheet.toString()).to.be('html {\n' + '  color: red;\n' + '}\n' + '@media (max-width: 767px) {\n' + '  html {\n' + '    color: green;\n' + '  }\n' + '}');
    });
    it('should handle conditionals with nesting inside', () => {
      ...
      expect(sheet.toString()).to.be('@media (max-width: 767px) {\n' + '  html {\n' + '    color: red;\n' + '  }\n' + '  html button {\n' + '    color: green;\n' + '  }\n' + '}');
    });
  });
});