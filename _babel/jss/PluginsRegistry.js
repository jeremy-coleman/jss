...
export default class PluginsRegistry {
  ...
  use(newPlugin, options = {
    queue: 'external'
  }) {
    const plugins = this.plugins[options.queue]; // Avoids applying same plugin twice, at least based on ref.
    ...
    this.registry = [...this.plugins.external, ...this.plugins.internal].reduce((registry, plugin) => {
