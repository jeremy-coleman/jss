...
const shouldIsolate = (rule, sheet, options) => {
  ...
  let isolate = options.isolate == null ? true : options.isolate; // $FlowFixMe: isolate is only added as an option by this plugin which means we can't type it in jss
