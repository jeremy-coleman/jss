...
class GlobalContainerRule implements ContainerRule {
  ...
  constructor(key, styles, options: RuleOptions) {
    ...
    //this is definately broken, i tried to refactor it before and said f it
...
export default function jssGlobal(): Plugin {
  ...
  function onProcessRule(rule) {
    ...
    handleNestedGlobalContainerRule((rule as any as StyleRule))
    handlePrefixedGlobalRule((rule as any as StyleRule))
  }
