import React, { Component, ComponentType, ReactNode as Node } from 'react';
import hoistNonReactStatics from 'hoist-non-react-statics';
import { getDynamicStyles, SheetsManager, StyleSheet } from 'jss';
import { ThemeContext } from 'theming';
import warning from 'tiny-warning';

import { HOCProps, Options, Styles, InnerProps } from './types';
...
const NoRenderer = (props: {
  children?: Node
}) => props.children || null

const getStyles = <Theme extends {}>(styles: Styles<Theme>, theme: Theme, displayName: string) => {
 ...
 */
export default function withStyles<Theme extends {}, S extends Styles<Theme>>(styles: S, options?: Options<Theme> = {}) {
  ...
  return <Props extends InnerProps>(InnerComponent: ComponentType<Props> = NoRenderer): ComponentType<Props> => {
    ...
    const noTheme = {}
    // $FlowFixMe
    const getTheme = (props: HOCProps<Theme, Props>): Theme => isThemingEnabled && props.theme ? props.theme : noTheme
