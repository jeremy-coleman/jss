import { CSSSimpleRule, RuleOptions, JssStyle, ToCssOptions, BaseRule } from '../types';
...
export default {
  onCreateRule(key: string, value: JssStyle, options: RuleOptions): SimpleRule | null {
    return key in keysMap ? new SimpleRule(key, (value as any as string), options) : null;
  }
}
