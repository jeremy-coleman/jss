...
export default class RuleList {
  ...
  constructor(options: RuleListOptions) {
    //this is bad imo partially moving parts of 1 object - this is assigning both options.classes and classes to values in this class
    //badddddd 
    //also the RuleListOptions need to match this class's options
