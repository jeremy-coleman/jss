...
export default class Jss {
  ...
  options: InternalJssOptions = {
    ...
    //the two renderer intefaces don't match..at all - thats why this is an error
    //honestly, i don't think it makes any sense to type the 'VirtualRenderer' since the implementation
    //is going to have to inhereently mock the dom, why not just type a single renderer to the dom
