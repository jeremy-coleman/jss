...
export default class StyleSheet {
  ...
  //retype this to AbstractRenderer, and make the DomRenderer and VirtualRenderer implement the abstract interface
  //i don't recommend creating an AbstractClass and extending it. just implement the interface to make sure ther's a 1:1 map to the sharable props
  renderer: any //Object;
  ...
  constructor(styles: Object, options: StyleSheetOptions) {
    ...
    this.options = {
      ...
      // click StyleSheetOptions and hit f12, add it
