...
export default class Jss {
    ...
    createStyleSheet(styles, options = {}) {
        ...
        const sheet = new StyleSheet(styles, Object.assign({}, options, { jss: this, generateId: options.generateId || this.generateId, insertionPoint: this.options.insertionPoint, Renderer: this.options.Renderer, index }));
    ...
    createRule(name, style = {}, options = {}) {
        ...
        const ruleOptions = Object.assign({}, options, { jss: this, Renderer: this.options.Renderer });
