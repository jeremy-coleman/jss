...
export default function jssNested() {
    ...
    function getReplaceRef(container, sheet) {
        return (match, key) => {
            ...
            warning(false, `[JSS] Could not find the referenced rule ${key} in ${container.options.meta ||
                container.toString()}.`);
            return key;
        };
    }
    ...
    function getOptions(rule, container, options) {
        ...
        return Object.assign({}, rule.options, { nestingLevel, index: container.indexOf(rule) + 1 });
    }
    function onProcessStyle(style, rule, sheet) {
        ...
        for (const prop in style) {
            ...
            if (isNested) {
                ...
                container.addRule(selector, style[prop], Object.assign({}, options, { selector }));
            }
